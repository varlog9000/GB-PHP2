...
<body>
<a href="../">__назад__</a>
<h3>Файлы классов находятся в папке <a href="classes/">classes</a></h3>
Классы написаны на php и не отобразятся при открытии из индексного файла директории.
...
Создал класс User. он способен авторизовать пользователя по логину и паролю, изменять настройки пользователя, например
...
<ol>
    ...
    <li>Редактировать параметры учетных записей пользователей</li>
    <li>Удалять пользователей</li>
    <li>Редактировать права ролей пользователей на чтение и на запись</li>
</ol>
Есть еще роли пользователей: Исполнитель (Executor) и Логист (Logist), они являются
потомками от класса пользователь (User), но ни чем его пока не расширяют.

Разница в функциолнале ролей пользователей будет определяться их правами на отображение и запись
других объектов
